    ...
    var body: some View {
        NavigationView {
            VStack {
                ...
                List {
                    ForEach(cardListViewModel.cardsViewModel.filter { $0.swiftCard.passed == showPassed }) { cardVM in
                        CardView(cardViewModel: cardVM).onLongPressGesture(minimumDuration: 1.5) {
